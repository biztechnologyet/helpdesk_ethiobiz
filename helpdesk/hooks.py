...
# WALTA PATCH START
app_include_js = (app_include_js if "app_include_js" in locals() else []) + ["/assets/bismillah_ethiobiz/js/walta.js"]
app_include_css = (app_include_css if "app_include_css" in locals() else []) + ["/assets/bismillah_ethiobiz/css/walta.css"]
web_include_js = (web_include_js if "web_include_js" in locals() else []) + ["/assets/bismillah_ethiobiz/js/walta.js"]
web_include_css = (web_include_css if "web_include_css" in locals() else []) + ["/assets/bismillah_ethiobiz/css/walta.css"]
# WALTA PATCH END
